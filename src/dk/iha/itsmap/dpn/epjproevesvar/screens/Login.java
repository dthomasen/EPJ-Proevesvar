...
public class Login extends Activity {
	...
	private final Activity parentActivity = this; 
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			...
			try {
				...
				//--------------------------------
				HttpGet httpRequest = new HttpGet("http://130.225.184.205:8082/pfpas-mobile/rest/common/login");
		...
		protected void onPostExecute(final Boolean success) {
			...
			if (success) {
				Intent i = new Intent(parentActivity, MainMenu.class);
				i.putExtra("Authorization", encoding);
		  		startActivity(i);
				finish();
			} else {
				mPasswordView
